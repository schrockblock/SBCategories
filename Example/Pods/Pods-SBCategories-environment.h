...
// SBCategories
#define COCOAPODS_POD_AVAILABLE_SBCategories
#define COCOAPODS_VERSION_MAJOR_SBCategories 0
#define COCOAPODS_VERSION_MINOR_SBCategories 1
#define COCOAPODS_VERSION_PATCH_SBCategories 0
